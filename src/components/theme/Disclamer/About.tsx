    ...
    return (
        <>
            <ul className="ListRemoveStyling pb-1">
                ...
                <li><EyeScreened className="inline" title="Personvern"/> Ikke legg inn personopplysninger som navn, telefon og e-post i denne demoen. Du kan legge til dette når du sender søknaden.</li>
            </ul>
        </>
    );
}
