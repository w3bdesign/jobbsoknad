...
const Footer = () => {
    return (
        ...
        <footer
            ...
            data-hj-suppress
            data-theme="dark"
            className="mt-14 flex pt-3 z-10 items-center w-5/6 max-w-[80rem] m-auto justify-between toc-ignore text-text-on-inverted bg-deepblue-800 relative flex justify-center"
        >
...
function LogoBlock() {
    return (
        <div>
            <span className="mt-4 text-2xl whitespace-nowrap">Demo</span>
    ...
    return (
        <div>
            ...
            <BodyShort as="ul" className="mt-3 grid gap-3">
                <FooterLink href="/om-felgen">
                    Hva er Felgen?
                </FooterLink>
                <FooterLink href="https://forms.office.com/r/UyFMJsLfKM?lang=nb-NO">
                    Innspill til Felgen
                </FooterLink>
            </BodyShort>
        </div>
