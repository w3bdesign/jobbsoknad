            ...
            <main>
                <div style={{maxWidth: "600px", marginLeft: "auto", marginRight: "auto"}}>
                    ...
                    <div className="mb-12 mt-5 max-w-2xl font-serif">
                        ...
                        <p className="mb-4 leading-normal">Ettersom Jobbsknad Demo er en demo, har vi valgt å ikke publisere en tilgjengelighetserklæring for denne per dags dato. Dette vil bli gjort dersom konseptet taes videre.</p>
